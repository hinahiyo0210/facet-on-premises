        ...
        return this.each(function (key, item) {
            ...
            function onResize() {
                ...
                $fixedHeader.find("th").each(function (index) {
                    ...
                    $(this).css("min-width", $originalHeader.find("th").eq(index).outerWidth() - 5);
                    $(this).css("max-width", $originalHeader.find("th").eq(index).outerWidth() - 5);
                });
            }
            ...
            function onScroll() {
                ...
                $fixedHeader.find('th').each(function (key, item) {
                    $(item).css('min-width', parseInt(originalWidth[key] - 5, 10));
                    $(item).css('max-width', parseInt(originalWidth[key] - 5, 10));
                });
