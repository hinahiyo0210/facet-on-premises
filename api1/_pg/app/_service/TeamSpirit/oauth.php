...
class oauth {
  ...
  public function __construct($client_id, $client_secret, $callback_url, $contractor){
      $this->client_id = $client_id;
      $this->client_secret = $client_secret;
      $this->callback_url = $callback_url;
      $this->login_url = 'https://login.salesforce.com';
      $this->token_url = "https://login.salesforce.com/services/oauth2/token";
      $this->cache_dir = "/var/www/html/api1/_pg/app/_service/TeamSpirit/oauthFile/$contractor";
  }
