...
<div class="api">
	...
	{* <section>
		<h2>/api1/device/getPushResponseMsg</h2>
		<form action="../device/getPushResponseMsg" method="get" target="device/getPushResponseMsg">
			<br />
			<input type="submit" value="submit" />
		</form>
		<iframe src="about:blank" name="device/getPushResponseMsg"></iframe>
	</section>

	<section>
		<h2>/api1/device/registPushResponseMsg</h2>
		<form action="../device/registPushResponseMsg" method="post" target="device/registPushResponseMsg">
			<div class="item">customTip: <textarea name="custom_tip" wrap="hard" style="width:200px;height:40px" value=""></textarea></div>
			<div class="item">tipsTime: <input type="text" name="tips_time" value="" /></div>
			<div class="item">borderColor: <input type="text" name="border_color" value="" placeholder="R,G,B,A"/></div>
			<div class="item">backgroundColor: <input type="text" name="background_color" value="" placeholder="R,G,B,A"/></div>
			<div class="item">priority: <input type="text" name="priority" value="" /></div>
			<div class="item any_prm" style="display:none">deviceGroupIdSet: <input type="text" name="device_group_id_set" value="" /></div>
			<div class="item any_prm" style="display:none">deviceIdSet: <input type="text" name="device_id_set" value="" /></div>
			<div class="item any_prm" style="display:none">personIdSet: <input type="text" name="person_id_set" value="" /></div>
			<div class="item any_prm" style="display:none">passSet: <input type="text" name="pass_set" value="" /></div>
			<div class="item any_prm" style="display:none">passFlagSet: <input type="text" name="pass_flag_set" value="" /></div>
			<div class="item any_prm" style="display:none">doorIndex: <input type="text" name="door_index" value="0" /></div>
			<div class="item any_prm" style="display:none">openDelay: <input type="text" name="open_delay" value="0" /></div>
			<a style="padding-left:31.5em;" href="javascript:void(0);" onclick="$(this).hide(); $('.any_prm').slideDown(200)">more</a>
				<br />
				<input type="submit" value="submit" />
		</form>
		<iframe src="about:blank" name="device/registPushResponseMsg"></iframe>
	</section>

	<section>
		<h2>/api1/device/deletePushResponseMsg</h2>
		<form action="../device/deletePushResponseMsg" method="get" target="device/deletePushResponseMsg">
			<div class="item">pushResponseMsgId: <input type="text" name="pushResponseMsgId" value="" /></div>
			<br />
			<input type="submit" value="submit" />
		</form>
		<iframe src="about:blank" name="device/deletePushResponseMsg"></iframe>
	</section> *}
...
<div class="api">
	...
	<section>
		...
		<form action="../person/registPersonAcessTimeForCloud" method="get" target="person/registPersonAcessTimeForCloud">
			...
			<div class="item">serialNo: <input type="text" name="serialNo" value="" /></div>
			{for $i=1 to 10}
				<div class="item time_input" {if $i >= 3}style="display:none"{/if}>accessFlag_{$i}: <input type="text" name="accessFlag_{$i}" value="" /></div>
				<div class="item time_input" {if $i >= 3}style="display:none"{/if}>accessTimeFrom_{$i}: <input type="text" name="accessTimeFrom_{$i}" value="" /></div>
				<div class="item time_input" {if $i >= 3}style="display:none"{/if}>accessTimeTo_{$i}: <input type="text" name="accessTimeTo_{$i}" value="" /></div>
			{/for}
	...
	<section>
		...
		<form action="../person/registPersonCardInfoForCloud" method="get" target="person/registPersonCardInfoForCloud">
			<div class="item">personCode: <input type="text" name="personCode" value="" /></div>
			{for $i=1 to 3}
				<div class="item time_input" >card_no_{$i}: <input type="text" name="card_no_{$i}" value="" /></div>
				<div class="item time_input" >validityDateFrom_{$i}: <input type="text" name="validityDateFrom_{$i}" value="" /></div>
				<div class="item time_input" >validityDateTo_{$i}: <input type="text" name="validityDateTo_{$i}" value="" /></div>
			{/for}
			<br />
			<input type="submit" value="submit" />
		</form>
