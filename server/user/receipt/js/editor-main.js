...
$(function () {
    var h = window.localStorage, e, a, d;
    var c, b, f, g;
    ...
    $("#tabs").tabs({
        select: function (i, j) {
            switch (tabindex) {
                ...
                //     if (
                //         $("#setting-ipaddr").val() != c ||
                //         $("#setting-port").val() != b ||
                //         $("#setting-devid").val() != f ||
                //         $("#setting-timeout").val() != g
                //     ) {
                //         connectPrinter();
                //     } else {
                //         setStatusMonitor();
...
function extract(a) {
    ...
    a.find(
        ".attr-text-x, .attr-text-y, .attr-area-y, .attr-position-x, .attr-position-y, " +
            ".attr-line-x1, .attr-line-y1, .attr-line-x2, .attr-line-y2, " +
            ".attr-rectangle-x1, .attr-rectangle-y1, .attr-rectangle-x2, .attr-rectangle-y2"
    ).each(function () {
